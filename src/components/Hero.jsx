...
const Hero = ({ heroapi: {title, subtitle, btntext,
sociallinks, img, videos}}) => {
  ...
  return (
    ...
    <div className="relative h-auto w-auto flex flex-col">
      ...
      top-0 left-0 right-0 z-10 opacity-100"></div>
      ...
      justify-items-center nike-container">
        <div className="grid items-center justify-items-center mt-28 md:mt-24">
          ...
          xsm:text-2xl font-extrabold filter drop-shadow-sm text-slate-200'>{title}</h1>
          <h1 className='text-6xl lg:text-5xl md:text-4xl sm:text-3xl 
          xsm:text-2xl font-extrabold filter drop-shadow-sm text-slate-200'>{subtitle}</h1>
          <button type='button' 
